  ...
  "targets": [
    {
      ...
      "sources": [
        ...
        "rocksdb/db/blob/blob_gen2_format.cc",
        ...
        "rocksdb/db/blob/blob_write_batch_transformer.cc",
        ...
        "rocksdb/db/wide/read_path_blob_resolver.cc",
        ...
        "rocksdb/util/coro_stats_util.cc",
        ...
        "rocksdb/utilities/copy_engine/copy_engine.cc",
        ...
        "rocksdb/utilities/sorted_run_builder/sorted_run_builder.cc",
